...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("page")
    .setDescription(
      "Provides you with a link to this server's page on VitalServers."
    ),
  async execute(interaction) {
    ...
    const embed = new EmbedBuilder()
      ...
      .setDescription(
        "Click on the button below to go to this server's page on VitalServers."
      )
      .setFooter({
        text: `VitalList - Page Command`,
